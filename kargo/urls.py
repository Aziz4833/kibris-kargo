...
urlpatterns = [
    ...
    path('firma/<slug:slug>/urun/<int:pk>/', views.urun_detay, name='urun_detay'),
    ...
    path('panel/satici-yetkisi/yeni/', views.satici_yetkisi_ekle, name='satici_yetkisi_ekle'),
    path('panel/satici-yetkisi/<int:pk>/sil/', views.satici_yetkisi_sil, name='satici_yetkisi_sil'),
    path('panel/sirket-kategorisi/yeni/', views.sirket_kategorisi_ekle, name='sirket_kategorisi_ekle'),
    path('panel/sirket-kategorisi/<int:pk>/sil/', views.sirket_kategorisi_sil, name='sirket_kategorisi_sil'),
